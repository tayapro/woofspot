...
def send_email(user, event, action):
    ...
    with get_connection(host=settings.EMAIL_HOST,
        ...
        if action == "event_changed" or action == "event_cancelled":
            ...
            recipient_list = list(attendees) + [event.organizer]
            ...
            for recipient in recipient_list:
                ...
                text_content = render_to_string(
                        f'event_app/emails/{action}.txt',
                        context)
                html_content = render_to_string(
                        f'event_app/emails/{action}.html',
                        context)
...
def send_contact_us_email(name, email_from, comment):
    ...
    with get_connection(
        ...
        text_content = render_to_string(
            "event_app/emails/contact_us_submitted.txt", context)
        html_content = render_to_string(
            "event_app/emails/contact_us_submitted.html", context)
